...
public class TestExecutionResult {
    ...
    public boolean hasFailures() { return failedTests > 0 || errorTests > 0 || exitCode != 0; }
    public int getFailureCount() { return failedTests; }
    public int getErrorCount() { return errorTests; }
